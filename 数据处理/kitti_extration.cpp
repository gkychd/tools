...
int main()
{
    string gtFilepath = "/home/gky/slam_results/kitti/lvi_点云环境短时退化/loop/keyframe_optimized_poses.txt";//数量较多的位姿
    string gtTimepath = "/home/gky/slam_results/kitti/lvi_点云环境短时退化/loop/simKeyframe_Time.txt";
    string keyFramepath = "/home/gky/slam_results/kitti/lvi_点云环境短时退化/loop/degradation_keyframe_optimized_poses.txt";//数量较少的位姿
    string keyFrametimepath = "/home/gky/slam_results/kitti/lvi_点云环境短时退化/loop/degradation_simKeyframe_Time.txt";
    string gtkeyFramepath = "/home/gky/slam_results/kitti/lvi_点云环境短时退化/loop/07_nodegradation.txt";
